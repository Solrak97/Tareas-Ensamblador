...
hilera0:   db  'adannocallaconnada', 0 ; 17 + 1
hilera1:   db  'anitalagordalagartonanotragaladrogalatina', 0 ; 40 + 1
hilera2:   db  'davidanadaeresmiamadanavidad', 0 ; 27 + 1
hilera3:   db  'secortasaritaatirasatroces', 0 ; 25 + 1
hilera4:   db  'asimaloirasorrosariolamisa', 0 ; 25 + 1
hilera5:   db  'saritasosaesidoneaenodiseasosatiras', 0 ; 34 + 1
hilera6:   db  'sorrebecahiceberror', 0 ; 18 + 1
hilera7:   db  'olamoromoromalo', 0 ; 14 + 1
